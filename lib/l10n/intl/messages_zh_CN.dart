...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(count) => "已读取 ${count} 个账户";

  static String m1(count) => "本次快照缺少上次读取的 ${count} 个账户";

  static String m2(time) => "最后成功更新时间：${time}";

  static String m3(time) => "重置时间 ${time}";

  static String m4(time) => "快照读取时间：${time}";

  static String m5(used, remaining) => "已用 ${used} · 剩余 ${remaining}";
  ...
  static String m8(url) => "是否要通过 ${url} 创建配置？";

  static String m9(count) => "${count} 天前";

  static String m10(label) => "确定删除选中的${label}吗？";

  static String m11(label) => "确定删除当前${label}吗？";

  static String m12(label) => "${label}详情";

  static String m13(label) => "${label}不能为空";

  static String m14(count) => "${count} 个条目";

  static String m15(label) => "${label}当前已存在";

  static String m16(name) => "${name} 已是最新版本";

  static String m17(name) => "${name} 已更新";

  static String m18(count) => "${count} 小时前";

  static String m19(count) => "${count} 小时";

  static String m20(target) => "${target} 是一个无效的策略";

  static String m21(proxyName) => "${proxyName} 是一个无效的代理";

  static String m22(providerName) => "${providerName} 是一个无效的代理集";

  static String m23(subRule) => "${subRule} 是一个无效的SUB_RULE";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "codexAccounts": MessageLookupByLibrary.simpleMessage("Codex 账户"),
    "codexAccountsHint": MessageLookupByLibrary.simpleMessage(
      "只读 CodexBar 快照；刷新按钮只重新读取文件",
    ),
    ...
    "codexDataAnomaly": MessageLookupByLibrary.simpleMessage("数据异常 / 待更新"),
    "codexExhausted": MessageLookupByLibrary.simpleMessage("已用尽"),
    "codexExpired": MessageLookupByLibrary.simpleMessage("数据过期"),
    "codexFiveHour": MessageLookupByLibrary.simpleMessage("5 小时额度"),
    "codexInvalidSnapshot": MessageLookupByLibrary.simpleMessage("快照格式异常"),
    "codexLastSuccessfulUpdate": m2,
    "codexNoAccounts": MessageLookupByLibrary.simpleMessage("快照中没有账户"),
    "codexNoHistoricalData": MessageLookupByLibrary.simpleMessage("没有可保留的历史数据"),
    "codexNormal": MessageLookupByLibrary.simpleMessage("正常"),
    "codexReadFailed": MessageLookupByLibrary.simpleMessage(
      "快照读取失败，正在显示上次成功数据",
    ),
    "codexResetAt": m3,
    "codexSnapshotReadAt": m4,
    "codexUnavailable": MessageLookupByLibrary.simpleMessage("不可用"),
    "codexUnsupportedPlatform": MessageLookupByLibrary.simpleMessage(
      "Codex 快照仅支持 Windows",
    ),
    "codexUsedRemaining": m5,
    "codexWeekly": MessageLookupByLibrary.simpleMessage("周额度"),
